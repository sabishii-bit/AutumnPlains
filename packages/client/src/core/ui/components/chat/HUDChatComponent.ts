...
export class HUDChatComponent {
    ...
    private setupElements() {
        ...
        this.addMessage('System', 'Press Enter to toggle chat. Type /help for commands.');
    }
    ...
    public setActive(active: boolean): void {
        ...
        if (active) {
            ...
            // Release all held keys and call their release() methods
            // This prevents stuck keys and ensures proper character control
            this.inputManager.releaseAllHeldKeys();
            ...
            // The canvas element should be the first canvas on the page
