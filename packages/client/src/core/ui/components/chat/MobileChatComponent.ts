import { NetClient } from '../../../networking/NetClient';
...
import { InputCommand } from '../../../controls/commands/InputCommand';
...
export class MobileChatComponent {
    ...
    private mobileInputManager: MobileInputManager | null = null;
    ...
    /**
     * Set the mobile input manager reference to control joystick visibility
     */
    public setMobileInputManager(mobileInputManager: MobileInputManager): void {
        this.mobileInputManager = mobileInputManager;
    }
    ...
    private toggleJoysticksVisibility(visible: boolean): void {
        if (this.mobileInputManager) {
            if (visible) {
                this.mobileInputManager.show();
            } else {
                this.mobileInputManager.hide();
            }
        }
    }
